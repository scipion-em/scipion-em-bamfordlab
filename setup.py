...
from bamfordlab import __version__
...
setup(
    ...
    name='scipion-em-bamfordlab',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-bamfordlab',  # Optional
    ...
    package_data={  # Optional
        'bamfordlab': ['bamfordlab_logo.gif', 'protocols.conf'],
    },
